...
HX_LOCAL_STACK_FRAME(_hx_pos_df13cafffbed243f_2_main,"Test","main",0x9c6c95b5,"Test.main","Test.hx",2,0x8afb218c)
...
void Test_obj::main(){
            	HX_STACKFRAME(&_hx_pos_df13cafffbed243f_2_main)
HXLINE(   3)		::Array< int > a = ::Array_obj< int >::__new(0);
HXLINE(   4)		{
HXLINE(   4)			int _g = 0;
HXDLIN(   4)			while((_g < 1000)){
HXLINE(   4)				_g = (_g + 1);
HXDLIN(   4)				int i = (_g - 1);
HXDLIN(   4)				a->push(i);
            			}
            		}
HXLINE(   5)		::haxe::Log_obj::trace(((HX_("Allocated ",59,17,04,b6) + a->length) + HX_(" ints",c4,d4,8d,b2)),::hx::SourceInfo(HX_("Test.hx",8c,21,fb,8a),5,HX_("Test",72,f4,d2,37),HX_("main",39,38,56,48)));
            	}
