...
HXCPP_EXTERN_CLASS_ATTRIBUTES void  __hxcpp_gc_enter_gameplay(int inReserveBytes, int inMaxHeadroomBytes);
HXCPP_EXTERN_CLASS_ATTRIBUTES void  __hxcpp_gc_leave_gameplay(bool inCollectNow);
HXCPP_EXTERN_CLASS_ATTRIBUTES double __hxcpp_gc_last_pause_ms();
HXCPP_EXTERN_CLASS_ATTRIBUTES double __hxcpp_gc_gameplay_max_pause_ms();
HXCPP_EXTERN_CLASS_ATTRIBUTES int   __hxcpp_gc_gameplay_deferred_full_count();
HXCPP_EXTERN_CLASS_ATTRIBUTES int   __hxcpp_gc_gameplay_emergency_full_count();
HXCPP_EXTERN_CLASS_ATTRIBUTES bool  __hxcpp_gc_is_gameplay_mode();
HXCPP_EXTERN_CLASS_ATTRIBUTES int   __hxcpp_gc_telemetry_metric_count();
HXCPP_EXTERN_CLASS_ATTRIBUTES int   __hxcpp_gc_telemetry_sample_count(int inRequiredFlags);
HXCPP_EXTERN_CLASS_ATTRIBUTES double __hxcpp_gc_telemetry_read(int inMetric, int inStatistic, int inRequiredFlags);
HXCPP_EXTERN_CLASS_ATTRIBUTES int   __hxcpp_gc_telemetry_last_flags();
HXCPP_EXTERN_CLASS_ATTRIBUTES void  __hxcpp_gc_telemetry_reset();
